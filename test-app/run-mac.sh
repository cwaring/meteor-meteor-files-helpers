...
export EXPECTED_METEOR_TOOL_PATH=/Users/jonas/.meteor/packages/velocity_meteor-tool/.1.1.1_1.1kyiydg++os.osx.x86_64+web.browser+web.cordova/mt-os.osx.x86_64
