...
export JASMINE_SERVER_MIRROR_APP_PATH=/tmp/meteor-test-run
...
## Jonas Ubuntu
export EXPECTED_APP_PATH=/tmp/meteor-test-run
export EXPECTED_METEOR_TOOL_PATH=/home/jonas/.meteor/packages/velocity_meteor-tool/.1.1.1_1.1a60gz5++os.linux.x86_64+web.browser+web.cordova/mt-os.linux.x86_64
export EXPECTED_METEOR_INSTALLATION_PATH=/home/jonas/.meteor
export EXPECTED_LOCAL_PACKAGE_NODE_MODULE_PATH=/tmp/meteor-test-run/.meteor/local/isopacks/sanjo_node-module-test/npm/node_modules/fs-extra
export EXPECTED_INSTALLED_PACKAGE_NODE_MODULE_PATH=/tmp/meteor-test-run/.meteor/local/build/programs/server/npm/ddp/node_modules/sockjs
